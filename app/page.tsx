...
const services = [
  { title: 'Storm Damage Roof Claims', desc: 'Spartanburg sees its share of severe weather. We navigate the entire insurance claim process so you get the roof repair or replacement your home deserves — without the runaround.', icon: serviceIcons[0] },
  { title: 'Hail Damage Assessment', desc: 'After an Upstate hailstorm, hidden damage can cost you thousands down the road. Our certified inspectors document every dent and crack to maximize your claim payout.', icon: serviceIcons[1] },
  { title: 'Wind Damage Restoration', desc: 'High winds tearing through the Piedmont can lift shingles and compromise your roof\'s integrity. We handle the claim filing and restoration from first call to final inspection.', icon: serviceIcons[2] },
  { title: 'Insurance Claim Negotiation', desc: 'Denied or underpaid claim? We go to bat against insurance adjusters with detailed documentation and local expertise that gets Spartanburg homeowners the settlement they\'re owed.', icon: serviceIcons[3] },
  { title: 'Emergency Roof Tarping', desc: 'When a storm hits and your roof can\'t wait, our crew provides fast emergency tarping to prevent further damage — and we document everything for your insurance claim from day one.', icon: serviceIcons[4] },
  { title: 'Full Roof Replacement', desc: 'From tear-off to final shingle, we manage complete roof replacements backed by manufacturer warranties. Spartanburg families trust us to coordinate every detail with their insurer.', icon: serviceIcons[5] },
];

const trustItems = [
  'Trusted by 800+ Spartanburg County Homeowners',
  'Licensed, Bonded & Insured in South Carolina',
  '$0 Out-of-Pocket on Approved Insurance Claims',
    ...
    <>
      ...
      <nav className="nav" role="navigation" aria-label="Main navigation">
        <div className="nav-inner">
          <span className="nav-logo">{'Next Level Roofing Claim Services'}</span>
          <a
            href="tel:18643818534"
            className="nav-phone-btn"
            aria-label="Call Next Level Roofing Claim Services at +1 864-381-8534"
          >
            <span
            ...
            />
            <span className="nav-phone-text">{'+1 864-381-8534'}</span>
          </a>
        </div>
      </nav>
        ...
        <div className="hero-content">
          <div className="hero-glass-card">
            ...
            <p className="hero-subtitle">
              ...
              {'Next Level Roofing Claim Services'} delivers durable, code-compliant roofing
              solutions that protect your home and family across {'Spartanburg'}.
            </p>
            <a
              href="tel:18643818534"
              className="hero-cta"
              aria-label="Call now at +1 864-381-8534"
            >
              <span
        ...
        <div className="about-inner">
          ...
          <div className="about-content">
            ...
            <h2 className="about-title" data-animate data-delay="1">
              Why {'Spartanburg'} Trusts {'Next Level Roofing Claim Services'}
            </h2>
            <p className="about-text" data-animate data-delay="2">
              {'Next Level Roofing Claim Services was built for one reason: to make sure Spartanburg homeowners never settle for less than they deserve after storm damage. We know these neighborhoods — from Westside to North Spartanburg — and we know how Upstate weather punishes a roof. Our team handles the heavy lifting with insurance companies so you can focus on your family, not your deductible.'}
            </p>
        ...
        <div className="cta-section-inner" data-animate>
          <div className="cta-glass-card">
            <h2 className="cta-section-title">
              Contact {'Next Level Roofing Claim Services'}
            </h2>
      ...
      <footer className="footer" role="contentinfo">
        <div className="footer-inner">
          <span className="footer-brand">{'Next Level Roofing Claim Services'}</span>
          <div className="footer-info">
            <div className="footer-info-item">
              ...
              />
              <span>
                {'104 A Franklin Ave, Spartanburg, SC 29301, USA'}, {'Spartanburg'}, {'SC'}
              </span>
            </div>
            <div className="footer-info-item">
              <span
          ...
          <div className="footer-copyright">
            &copy; {new Date().getFullYear()} {'Next Level Roofing Claim Services'}. All rights
